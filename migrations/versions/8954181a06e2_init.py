...
Revision ID: 8954181a06e2
Revises: 
Create Date: 2023-09-06 18:52:15.345029
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['model_id'], ['models.id'], name=op.f('fk_car_types_model_id_models')),
