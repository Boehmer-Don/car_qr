...
Revision ID: e81bf295f53e
Revises: 
Create Date: 2023-09-07 08:49:51.258821
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['type_id'], ['car_types.id'], name=op.f('fk_models_type_id_car_types')),
