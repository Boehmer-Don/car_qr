document.addEventListener('DOMContentLoaded', function () {
    ...
    const basicPlanButton: HTMLInputElement = document.querySelector("#basic_radio");
    const advancedPlanButton: HTMLInputElement = document.querySelector("#advanced_radio");
