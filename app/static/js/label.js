...
*/
  ...
  \**********************/
    ...
    function getLabelDetails(label) {
      ...
      var labelDateReceived = document.querySelector(
      ...
      var labelStickerIdentifier = document.querySelector(
    ...
    function deactivateLabel(label) {
      ...
      labelInfo.innerHTML = ''
        .concat(label.name, ' ')
        .concat(label.make, ' ')
        .concat(label.vehicle_model, ' ')
        .concat(label.year, ' - ')
        .concat(label.sticker_id);
    ...
    var labelDetailsModalWindow = new flowbite_1.Modal(
      $modalElement,
      modalOptions,
    );
    var labelDeactivateModalWindow = new flowbite_1.Modal(
    ...
    var labelDeactivateButtons = document.querySelectorAll(
    ...
    var decreaseQuantityButton = document.querySelector(
      '#decreaseQuantityButton',
    );
    var increaseQuantityButton = document.querySelector(
