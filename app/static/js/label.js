...
makeSelectMakeFields.forEach(function (makeSelectMakeField) {
    return makeSelectMakeField.addEventListener('change', function () {
        ...
        var stringSelected = makeSelectMakeField.value;
