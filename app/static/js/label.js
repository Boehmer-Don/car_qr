...
function deactivateLabel(label) {
    var labelActive = document.querySelector('#label-deactivate-active');
    ...
    labelInfo.innerHTML = "".concat(label.name, " ").concat(label.make, " ").concat(label.vehicle_model, " ").concat(label.year, " - ").concat(label.sticker_identifier);
...
var quantity = parseInt(quantityStr.innerHTML);
