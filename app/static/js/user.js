...
var resendInviteModal = new flowbite_1.Modal($modalResendInviteElement, modalOptions);
...
resendInviteButtons.forEach(function (e) {
    return e.addEventListener('click', function () {
        var user = JSON.parse(e.getAttribute('data-target'));
...
var resendInviteButtonClose = document.querySelector('#resendInviteModalCloseButton');
if (resendInviteButtonClose) {
    resendInviteButtonClose.addEventListener('click', function () {
