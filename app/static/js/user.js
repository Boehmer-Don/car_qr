...
var $modalresendInviteElement = document.querySelector('#resendInviteModal');
...
var resenrInviteModal = new flowbite_1.Modal($modalresendInviteElement, modalOptions);
...
var resendInviteButtons = document.querySelectorAll('.resend-invite-button');
resendInviteButtons.forEach(function (e) {
    return e.addEventListener('click', function () {
...
function editUser(user) {
    var input = document.querySelector('#user-edit-firstname');
...
function sendInvite() {
    var input = document.querySelector('#user-edit-password');
    input.value = '*******';
    input = document.querySelector('#user-edit-password_confirmation');
    input.value = '*******';
    input = document.querySelector('#user-edit-next_url');
